          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <HeadlineCard
                ...
                sub={`${result.counts.confirmed} confirmed · ${result.counts.refunded} refunded · ${result.counts.cancelled} cancelled${result.counts.testExcluded > 0 ? ` · ${result.counts.testExcluded} test excl.` : ""}${result.counts.stagingExcluded > 0 ? ` · ${result.counts.stagingExcluded} staging excl.` : ""}`}
                icon={Receipt}
                accent="blue"
              />
              <HeadlineCard
