  ...
  try {
    ...
    return NextResponse.json({
      ...
      reservation: {
        ...
        grandTotal: (resHistory?.grand_total || grandTotal || 0) + (triplyServiceFee || 0),
        serviceFee: triplyServiceFee || 0,
        dueNow: (resHistory?.grand_total || 0) + (triplyServiceFee || 0) - (resHistory?.due_at_location_total || 0),
        dueAtLocation: resHistory?.due_at_location_total || 0,
        customer: {
